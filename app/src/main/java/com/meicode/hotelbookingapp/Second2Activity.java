...
public class Second2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acivity_second2);
        second_back_arrow = findViewById(R.id.second2_back_arrow);
        second_arrow_up = findViewById(R.id.seconf2_arrow_up);
        second_title = findViewById(R.id.second2_title);
        second_subtitle = findViewById(R.id.second2_subtitle);
        second_rating_number = findViewById(R.id.second2_rating_number);
        second_rating_number2 = findViewById(R.id.second2_rating_number2);
        more_details = findViewById(R.id.more_details);
        second_ratingbar = findViewById(R.id.second2_ratingbar);

//        move from 2-2 to 1 activity
...
//        move from 2-2 to 3-2 activity
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
            @Override
            public void onClick(View view) {
//                change class to 3-2 acticvity class
                Intent intent = new Intent(Second2Activity.this, Third2Activity.class);
                Pair[] pairs = new Pair[1];
//                to take in its initial  stage from the 3 one .
                pairs[0] = new Pair<View, String>(second_arrow_up, "background_image_transition");
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Second2Activity.this, pairs);
