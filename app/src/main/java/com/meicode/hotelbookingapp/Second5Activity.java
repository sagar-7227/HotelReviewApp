...
public class Second5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_back_arrow = findViewById(R.id.second5_back_arrow);
        second_arrow_up = findViewById(R.id.seconf5_arrow_up);
        second_title = findViewById(R.id.second5_title);
        second_subtitle = findViewById(R.id.second5_subtitle);
        second_rating_number = findViewById(R.id.second5_rating_number);
        second_rating_number2 = findViewById(R.id.second5_rating_number2);
        more_details = findViewById(R.id.more_details);
        second_ratingbar = findViewById(R.id.second5_ratingbar);

//        move from 2-5 to 1 activity
...
//        move from 2-5 to 3-5 activity
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
            @Override
            public void onClick(View view) {
//                change class to 3-5 acticvity class
                Intent intent = new Intent(Second5Activity.this, Third5Activity.class);
                Pair[] pairs = new Pair[1];
//                to take in its initial  stage from the 3 one .
                pairs[0] = new Pair<View, String>(second_arrow_up, "background_image_transition");
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Second5Activity.this, pairs);
